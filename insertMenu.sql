...
INSERT INTO "main"."accounts_restaurant" ("id", "restaurant_name", "restaurant_key", "trade_license", "restaurantImg", "user_id") VALUES ('1', 'Pizza Inn', '123654', '12345', 'restaurant_img/default.png', '2');
INSERT INTO "main"."accounts_restaurant" ("id", "restaurant_name", "restaurant_key", "trade_license", "restaurantImg", "user_id") VALUES ('2', 'Madchef', '0', '123456764', 'restaurant_img/default.png', '3');

INSERT INTO "main"."browse_ingredient" ("id", "name") VALUES ('1', ' chicken ');
INSERT INTO "main"."browse_ingredient" ("id", "name") VALUES ('2', ' cheese ');

INSERT INTO "main"."browse_package" ("id", "pkg_name", "for_n_persons", "price", "available", "image", "details", "restaurant_id") VALUES ('1', 'Chicken Cheese Burger', '2', '150', '1', 'menu/cuisine1.jpg', 'Good Item', '1');
INSERT INTO "main"."browse_package" ("id", "pkg_name", "for_n_persons", "price", "available", "image", "details", "restaurant_id") VALUES ('2', 'Beef Cheese Burger', '2', '150', '1', 'menu/cuisine6.jpg', 'Good Item', '1');
