# Generated by Django 2.2.1 on 2019-07-19 12:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('PENDING', 'PENDING'), ('PROCESSING', 'PROCESSING'), ('DELIVERED', 'DELIVERED')], default='PENDING', max_length=15, verbose_name='Order Status')),
            ],
            options={
                'verbose_name': 'Order',
