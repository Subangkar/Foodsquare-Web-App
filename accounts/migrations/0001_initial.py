    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch_location', models.CharField(default='0,0', max_length=20, verbose_name='Openstreetmap co-ordinates')),
                ('branch_location_details', models.CharField(max_length=100, verbose_name="If co-ordinates can't be provided or floor-no")),
