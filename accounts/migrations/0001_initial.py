    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('PENDING', 'PENDING'), ('PROCESSING', 'PROCESSING'), ('DELIVERED', 'DELIVERED')], default='PENDING', max_length=15, verbose_name='Order Status')),
            ],
            options={
                'verbose_name': 'Order',
