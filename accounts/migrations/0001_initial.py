    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_delivery_man', models.BooleanField(default=False, verbose_name='Delivery Account')),
            ],
            options={
                'verbose_name': 'User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('charge', models.FloatField(default=50, verbose_name='Delivery Fees')),
                ('time', models.DateTimeField(auto_now=True, verbose_name='Delivery Completion Time')),
                ('rating_user', models.IntegerField(null=True, verbose_name='User Rating')),
                ('rating_deliveryman', models.IntegerField(null=True, verbose_name='Delivery Man Rating')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('PENDING', 'PENDING'), ('PROCESSING', 'PROCESSING'), ('PROCESSING', 'DELIVERING'), ('DELIVERED', 'DELIVERED')], default='PENDING', max_length=15, verbose_name='Order Status')),
            ],
            options={
                'verbose_name': 'Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('P', 'Paid'), ('D', 'Due')], default='D', max_length=1, verbose_name='Payment Status')),
                ('bkash_ref', models.CharField(blank=True, max_length=30, null=True, verbose_name='Bkash ref')),
            ],
            options={
